                    ...
                    >
                      ...
                      <div className="relative">
                        <motion.textarea
                          ...
                          placeholder=" "
                          rows={8}
                          className="peer w-full px-4 sm:px-5 py-4 sm:py-5 bg-white/50 border-2 border-black/10 rounded-xl sm:rounded-2xl outline-none transition-all duration-300 resize-none text-black"
                          style={{
                            fontSize: '1.125rem',
                            fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", system-ui, sans-serif',
